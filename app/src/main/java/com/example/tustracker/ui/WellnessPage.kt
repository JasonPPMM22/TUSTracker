...
fun WellnessPage(navController: NavHostController) {
    Column(
        ...
        val cameraPositionState = rememberCameraPositionState { // setting camera position to a remember state
            position =
                com.google.android.gms.maps.model.CameraPosition.fromLatLngZoom(tusCoordinates, 15f)
        }
        ...
        Box(
            ...
            GoogleMap(
                ...
                // On click of the location information will pop up such as the title and snippet
                Marker(
