...
fun StartPage(navController: NavHostController, viewModel: StartPageViewModel = viewModel()) {
    ...
    val errorMessage by viewModel.loginErrorMessage.asFlow().collectAsState(initial = null)
    ...
    Column(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text(text = "K-Number", fontWeight = FontWeight.Normal, fontSize = 18.sp) },
                isError = false,
            ...
            OutlinedTextField(
                ...
                label = { Text(text = "Password", fontWeight = FontWeight.Normal, fontSize = 18.sp) },
                isError = false,
                keyboardOptions = KeyboardOptions.Default,
                keyboardActions = KeyboardActions.Default,
...
fun StartPagePreview() {
    TUSTrackerTheme {
        // Pass a dummy NavHostController for the preview
